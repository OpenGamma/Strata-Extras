 ...
 */
public final class LegalEntityDiscountingMarketQuoteMeasure<T extends ResolvedTrade>
    implements LegalEntityDiscountingCalibrationMeasure<T> {

  /**
   * The measure for {@link ResolvedRepoTrade} using par rate discounting.
   */
  public static final LegalEntityDiscountingMarketQuoteMeasure<ResolvedRepoTrade> REPO_MQ =
      LegalEntityDiscountingMarketQuoteMeasure.of(
          "RepoParRateDiscounting",
          ResolvedRepoTrade.class,
          (trade, p) -> DiscountingRepoProductPricer.DEFAULT.parRate(trade.getProduct(), p),
          (trade, p) -> DiscountingRepoProductPricer.DEFAULT.parRateSensitivity(trade.getProduct(), p));
   ...
   */
  public static <R extends ResolvedTrade> LegalEntityDiscountingMarketQuoteMeasure<R> of(
      String name,
      Class<R> tradeType,
    ...
    return new LegalEntityDiscountingMarketQuoteMeasure<R>(name, tradeType, valueFn, sensitivityFn);
  }

  // restricted constructor
  private LegalEntityDiscountingMarketQuoteMeasure(
      String name,
      Class<T> tradeType,
